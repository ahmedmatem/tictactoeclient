namespace TicTacToe.Client.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        private Token GetNewToken(LoginViewModel model)
        {
            ...
            string postData = "username=" + model.Email + "&password=" + model.Password + "&grant_type=password";
        ...
        private bool IsAccessTokenExpired(Token token)
        {
            return DateTime.Now > token.ExpireDate ? true : false;
        }
        ...
        public Dictionary<string, object> JavaScriptSerizlizer { get; private set; }
